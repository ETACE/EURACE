...
This report updating the ealier deliverable on porting FLAME to parallel systems - Deliverable D1.4 - and presents the developments of FLAME and the porting of the EURACE Model during the final year of the project.
...
final year significant developments have been made to FLAME and the underlying Message Board Library that significantly improved both its serial and parallel performance.

The report presents the developments of FLAME and its associated analysis tools\end{abstract}
\pagebreak
