...
\section{Initial Data Generation} \input{cloning}
\section{Job Submission with ExpGUI} \input{expgui}
\section{Tools for FLAME and Model Assessment} \input{assessmenttools}
\section{Performance of the FLAME Framework} \input{assessmentFLAME}
%\section{Remote Job Submission} \input{jobsubmission}
%\section{Testing: Functional and Portability} \input{testing}
\section{Performance of EURACE Model} \input{benchmarks}
