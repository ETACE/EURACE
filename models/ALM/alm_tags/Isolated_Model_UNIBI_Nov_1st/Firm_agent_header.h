...
/** \def PLANNED_TOTAL_ASSETS
 * \brief Direct access to planned_total_assets of Firm agent memory variable. */
#define PLANNED_TOTAL_ASSETS (current_xmachine_Firm->planned_total_assets)
/** \def EQUITY
