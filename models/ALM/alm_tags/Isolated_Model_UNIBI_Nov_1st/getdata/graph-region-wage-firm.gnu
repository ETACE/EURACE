...
plot 'data-regional-wage-firm.csv' using 1:2 title "wage region 1", 'data-regional-wage-firm.csv' using 1:3 title "wage region 2" 
set output
...
# !epstopdf --outfile=graph-region-wage-firm.pdf graph-region-wage-firm.eps 
quit 
