...
int getiteration(char * filepath, int itno, firm ** pointer_to_firms, household ** pointer_to_households,IGfirm ** pointer_to_IGfirms,mall ** pointer_to_malls,Eurostat ** pointer_to_Eurostats)
{
	...
	int inproduction_quantity, incapital_stock, incum_revenue_last_month, inearnings, inprice;
	int intotal_sold_quantity, inplanned_production_quantity, inaccount, inprice_last_month, inmean_specific_skills, inmean_wage, intotal_debt, inreal_exports, innominal_exports, incapital_costs, inactual_cap_price;
	/*Household*/
	...
	double cum_revenue_last_month, earnings, price, total_sold_quantity, planned_production_quantity;
...
/*----------------------------FIRMS DAILY AND REGIONAL DATA-------------------------------------*/
	...
	while(current_firm)
	{
		...
		herfindahl_index+=current_firm-> pow(cum_revenue_last_month/consumption_nominal_total,2);
...
/*----------------------------FIRM MONTHLY AND REGIONAL DATA---------------------------------------*/
		...
		monthly_cum_revenue_last_month += ave_cum_revenue_last_month;
		monthly_cum_revenue_last_month_region_1 += ave_cum_revenue_last_month_region_1;
		monthly_cum_revenue_last_month_region_2 += ave_cum_revenue_last_month_region_2;
