...
set output 'graph-technology-skills-region_1.eps'
...
set terminal png
set output 'graph-technology-skills-region_1.png'
plot 'mean_specific_skills_region.csv' using 1:2 title "mean specific skills region 1", 'data-technology.csv' using 1:3 title "technology-region-1", 'data-technology.csv' using 1:5 title "technological-frontier"
set output

# Call external epstopdf to transform the eps file to pdf.
# !epstopdf --outfile=graph-technology-skills-region_1.pdf graph-technology-skills-region_1.eps 
quit 
