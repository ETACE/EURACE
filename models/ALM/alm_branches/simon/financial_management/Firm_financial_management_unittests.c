...
void unittest_Firm_apply_for_loans()
{
    ...
    //add_loan_request_message(ID, bank_id, EXTERNAL_FINANCIAL_NEEDS, TOTAL_ASSETS, TOTAL_DEBT, MSGDATA);
 	START_LOAN_REQUEST_MESSAGE_LOOP 
    	CU_ASSERT_EQUAL(loan_request_message->id, 1);
 		CU_ASSERT_EQUAL(loan_request_message->bank_id, 2);
 		CU_ASSERT_DOUBLE_EQUAL(loan_request_message->credit_amount, 10.0, 1e-3);
...
void unittest_Firm_read_loan_offers_send_loan_acceptance()
{
    ...
    //add_loan_acceptance_message(ID, loan_conditions_message->bank_id, loan_conditions_message->amount_credit_offer);
 	START_LOAN_ACCEPTANCE_MESSAGE_LOOP 
    	CU_ASSERT_EQUAL(loan_acceptance_message->id, 1);
 		CU_ASSERT_EQUAL(loan_acceptance_message->bank_id, 2);
 		CU_ASSERT_DOUBLE_EQUAL(loan_acceptance_message->credit_amount_taken, 10.0, 1e-3); 	
...
void unittest_Firm_compute_and_send_bond_orders()
{
    ...
    /***** Messages send *********************************************/
 	START_BOND_ORDER_MESSAGE_LOOP 
 		...
 		CU_ASSERT_EQUAL(bond_order_message->id, <value>);
 		CU_ASSERT_EQUAL(bond_order_message->bond_id, <value>);
 		CU_ASSERT_DOUBLE_EQUAL(bond_order_message->limit_price, <value>, 1e-3);
 		CU_ASSERT_DOUBLE_EQUAL(bond_order_message->limit_quantity, <value>, 1e-3);
...
void unittest_Firm_read_bond_transactions()
{
    ...
    /***** Messages send *********************************************/
 	START_BOND_TRANSACTION_MESSAGE_LOOP 
 		//bond_transaction_message(id, bond_id, limit_price, limit_quantity, MSGDATA);
 		CU_ASSERT_EQUAL(bond_transaction_message->id, <value>);
 		CU_ASSERT_EQUAL(bond_transaction_message->bond_id, <value>);
    	CU_ASSERT_DOUBLE_EQUAL(bond_transaction_message->limit_price, <value>, 1e-3);
 		CU_ASSERT_DOUBLE_EQUAL(bond_transaction_message->limit_quantity, <value>, 1e-3);
...
void unittest_Firm_read_stock_transactions()
{
    ...
    /***** Messages send *********************************************/
 	START_STOCK_TRANSACTION_MESSAGE_LOOP 
 		...
 		CU_ASSERT_EQUAL(stock_transaction_message->bond_id, <value>);
