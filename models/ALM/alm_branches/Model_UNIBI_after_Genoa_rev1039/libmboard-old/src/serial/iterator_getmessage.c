/* $Id: iterator_getmessage.c 760 2008-03-20 14:40:48Z lsc $ */
/*!
 * \file serial/iterator_getmessage.c
 * \code
 ...
 * \endcode
 * 
 * \brief Serial implementation of MB_Iterator_GetMessage()
 * 
 */
...
int MB_Iterator_GetMessage(MBt_Iterator itr, void **msg_ptr) {
    ...
    *msg_ptr = malloc((size_t)iter->msgsize);
    ...
    /*
    memcpy(*msg_ptr, PL_NODEDATA(iter->cursor), (size_t)iter->msgsize);
    */
    /* move cursor */
