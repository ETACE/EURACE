...
plot 'data-eurostat.csv' using 1:7 title "debt earnings ratio", 'data-eurostat.csv' using 1:8 title "debt equity ratio", 'data-eurostat.csv' using 1:9 title "labour share ratio"
set output
