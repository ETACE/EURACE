...
/** \fn Household_on_the_job_search_Yes_or_No()
 * \brief Households decide whether they search on the jon or not
 */
int Household_on_the_job_search_Yes_or_No()
{
...
int Household_handle_leftover_budget()
{
	...
	START_DIVIDEND_PAYMENT_MESSAGE_LOOP
		...
		RECEIVED_DIVIDEND_CONS += dividend_payment_message->current_dividend_per_share;
