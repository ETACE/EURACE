...
set output "graph-region-monthly-output.eps"
...
set terminal png
set output "graph-region-monthly-output.png"
plot 'data-region-monthly-output.csv' using 1:2 title "monthly-output",'data-region-monthly-output.csv' using 1:5 title "monthly-output-region-1",'data-region-monthly-output.csv' using 1:8 title "monthly-output-region-2" 
set output

# Call external epstopdf to transform the eps file to pdf.
# !epstopdf --outfile=graph-region-monthly-output.pdf graph-region-monthly-output.eps 
quit 
