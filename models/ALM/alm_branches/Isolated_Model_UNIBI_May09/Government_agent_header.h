...
/** \def VALUE_BONDS_OUTSTANDING
 * \brief Direct access to value_bonds_outstanding of Government agent memory variable. */
#define VALUE_BONDS_OUTSTANDING (current_xmachine_Government->value_bonds_outstanding)
/** \def NR_BONDS_OUTSTANDING
 * \brief Direct access to nr_bonds_outstanding of Government agent memory variable. */
#define NR_BONDS_OUTSTANDING (current_xmachine_Government->nr_bonds_outstanding)
