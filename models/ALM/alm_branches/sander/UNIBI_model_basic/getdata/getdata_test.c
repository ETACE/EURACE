...
void savedatatofile(int itno, firm ** pointer_to_firms, household ** pointer_to_households,IGfirm ** pointer_to_IGfirms,mall ** pointer_to_malls)
{
	...
	double sold_quantities[10];
	double production_quantities[10];

	current_mall = *pointer_to_malls;
	while(current_mall)
	{
		if(current_mall->id==411)
			supply_mall1=current_mall->total_supply;
		else
			supply_mall2=current_mall->total_supply;
	...
	while(current_firm)
	{
	int i = current_firm->id-1;
	sold_quantities[i]=current_firm->total_sold_quantity;
	production_quantities[i]= current_firm->production_quantity;
	...
	file = fopen("mall_supply.csv", "a");
	
	sprintf(data, "%i", itno);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",supply_mall1);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f", supply_mall2);
	fputs(data, file);
	...
	file = fopen("sold_quantities.csv", "a");
	
	sprintf(data, "%i", itno);
	
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[0]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[1]);
	
	
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[2]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[3]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[4]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[5]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[6]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[7]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[8]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",sold_quantities[9]);
	fputs(data,file);
	fputs("\n", file);
	...
	file = fopen("production_quant.csv", "a");
	...
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[0]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[1]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[2]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[3]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[4]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[5]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[6]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[7]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[8]);
	fputs(data, file);
	fputs("\t", file);
	sprintf(data, "%f",production_quantities[9]);
	fputs(data,file);
...
int main( int argc, char **argv )
{
	...
	file = fopen("mall_supply.csv", "w");
	fclose(file);

	file = fopen("production_quant.csv", "w");
	fclose(file);

	

	file = fopen("sold_quantities.csv", "w");
	fclose(file);
