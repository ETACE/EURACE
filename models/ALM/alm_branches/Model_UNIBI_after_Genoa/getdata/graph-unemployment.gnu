...
set output 'graph-unemployment-color.eps'
plot 'data-unemployment.csv' using 1:2 title "unemployment-rate"
set output
...
# !epstopdf --outfile=graph-unemployment.pdf graph-unemployment.eps 
quit 
