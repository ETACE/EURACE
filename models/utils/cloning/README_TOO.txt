...
<id>
<gov_id>: to ensure new households are linked to the government in the region
<bank_id>: to ensure new households are linked to the bank(s) in the region

NOTE:
If you do not want the <gov_id> to be updated do a search-replace:
<gov_id>REPLACE_ID_
with
<gov_id>
...
- The pop-instantiate output with replacement markers puts replacement markets on all IDs, gov_ids and bank_id in the memory of the agents.
