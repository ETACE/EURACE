...
/** \fn void add_loan_conditions_message(double proposed_interest_rate, double amount_offered_credit, int firm_id, int bank_id, double variable)
...
/** \fn void add_installment_message(double installment, double interest, int bank_id, double variable_per_installment)
 ...
 * \param bank_id Message variable.
 * \param variable_per_installment Message variable.
 */
void add_installment_message(double installment, double interest, int bank_id, double variable_per_installment)
{
    ...
    msg.bank_id = bank_id;
    msg.variable_per_installment = variable_per_installment;
...
/** \fn void add_bankruptcy_message(int bank_id, double bad_debt, double credit_refunded, double residual_variable)
 ...
 * \param residual_variable Message variable.
 */
void add_bankruptcy_message(int bank_id, double bad_debt, double credit_refunded, double residual_variable)
{
    ...
    msg.residual_variable = residual_variable;
