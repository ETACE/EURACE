...
/** \def CASH
 * \brief Direct access to cash of Bank agent memory variable. */
#define CASH (current_xmachine_Bank->cash)
/** \def TOTAL_CREDIT
 * \brief Direct access to total_credit of Bank agent memory variable. */
#define TOTAL_CREDIT (current_xmachine_Bank->total_credit)
/** \def EQUITY
 * \brief Direct access to equity of Bank agent memory variable. */
#define EQUITY (current_xmachine_Bank->equity)
/** \def BCE_DEBT
 * \brief Direct access to bce_debt of Bank agent memory variable. */
#define BCE_DEBT (current_xmachine_Bank->bce_debt)
/** \def ALFA
 * \brief Direct access to alfa of Bank agent memory variable. */
#define ALFA (current_xmachine_Bank->alfa)
/** \def VARIABLE
 * \brief Direct access to variable of Bank agent memory variable. */
#define VARIABLE (current_xmachine_Bank->variable)
/** \def MIN_INTEREST
