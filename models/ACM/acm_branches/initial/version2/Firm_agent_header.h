...
/** \def RESIDUAL_VARIABLE
 * \brief Direct access to residual_variable of Firm agent memory variable. */
#define RESIDUAL_VARIABLE (current_xmachine_Firm->residual_variable)
/** \def VARIABLE_PER_INSTALLMENT
 * \brief Direct access to variable_per_installment of Firm agent memory variable. */
#define VARIABLE_PER_INSTALLMENT (current_xmachine_Firm->variable_per_installment)
/** \def VALUE_AT_RISK
