...
struct xmachine_memory_Firm
{
	...
	double_array residual_variable;	/**< X-machine memory variable residual_variable of type double_array. */
	double_array variable_per_installment;	/**< X-machine memory variable variable_per_installment of type double_array. */
...
struct xmachine_memory_Bank
{
	...
	double variable;	/**< X-machine memory variable variable of type double. */
...
struct m_loan_conditions
{
	...
	int firm_id;	/**< Message memory variable firm_id of type int. */
	int bank_id;	/**< Message memory variable bank_id of type int. */
	double variable;	/**< Message memory variable variable of type double. */
};
...
struct m_installment
{
	...
	int bank_id;	/**< Message memory variable bank_id of type int. */
	double variable_per_installment;	/**< Message memory variable variable_per_installment of type double. */
};
...
struct m_bankruptcy
{
	...
	double residual_variable;	/**< Message memory variable residual_variable of type double. */
};
...
int Firm_savings(void);
int Firm_ask_for_loan(void);
int Firm_choose_bank(void);
int Firm_pay_debt(void);
int Bank_update_HH_Firm_accounts(void);
...
/* Pointer to list of Firm agents in state firm_start state */
//xmachine_memory_Firm * temp_xmachine_Firm_firm_start;
xmachine_memory_Firm_state * Firm_firm_start_state;
/* Pointer to current $agent_name agent */
...
/* Pointer to list of Bank agents in state Bank_start state */
//xmachine_memory_Bank * temp_xmachine_Bank_Bank_start;
xmachine_memory_Bank_state * Bank_Bank_start_state;
/* Pointer to current $agent_name agent */
...
/* Pointer to list of Household agents in state HH_start state */
//xmachine_memory_Household * temp_xmachine_Household_HH_start;
xmachine_memory_Household_state * Household_HH_start_state;
...
void add_loan_conditions_message(double proposed_interest_rate, double amount_offered_credit, int firm_id, int bank_id, double variable);
...
void add_installment_message(double installment, double interest, int bank_id, double variable_per_installment);
...
void add_bankruptcy_message(int bank_id, double bad_debt, double credit_refunded, double residual_variable);
