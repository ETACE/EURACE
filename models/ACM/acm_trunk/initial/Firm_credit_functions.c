...
int Firm_ask_loan()
{
	...
	add_loan_request_message(ID, bank_name[0], EXTERNAL_FINANCIAL_NEEDS, TOTAL_ASSETS, TOTAL_DEBT);
	add_loan_request_message(ID, bank_name[2], EXTERNAL_FINANCIAL_NEEDS, TOTAL_ASSETS, TOTAL_DEBT);
	return 0;
}
