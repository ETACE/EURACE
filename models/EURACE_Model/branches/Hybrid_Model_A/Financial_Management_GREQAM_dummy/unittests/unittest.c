...
void unittest_Firm_set_bankruptcy_illiquidity(); //To create
void unittest_Firm_set_bankruptcy_insolvency(); //To create
void unittest_Firm_in_financial_crisis(); //To create
void unittest_Firm_bankruptcy_idle_counter(); //To create
void unittest1_Firm_bankruptcy_illiquidity_procedure(); //To create

void unittest_Firm_reset_bankruptcy_flags(); //To create
...
int main(int argc, char * argv[])
{
    ...
    if(
    	...
    	//NULL == CU_add_test(pSuite, "Firm_compute_balance_sheet", unittest_Firm_compute_total_liquidity_needs) ||
    	
    	//NULL == CU_add_test(pSuite, "Firm_check_financial_and_bankruptcy_state", unittest_Firm_check_financial_and_bankruptcy_state) ||
    	...
    	//NULL == CU_add_test(pSuite, "Firm_bankruptcy_illiquidity_procedure", unittest1_Firm_bankruptcy_illiquidity_procedure) ||

    	//NULL == CU_add_test(pSuite, "Firm_reset_bankruptcy_flags", unittest_Firm_reset_bankruptcy_flags) ||
    	//NULL == CU_add_test(pSuite, "Firm_execute_financial_payments", unittest_Firm_execute_financial_payments) ||
