...
#Parameters
#1. GA experiment
#export EXPERIMENT_NAME="prob_crossover"
#export F1_values=$(seq 0.50 0.10 0.90)

#2. GA experiment
export EXPERIMENT_NAME="default"
export F1_values=$(seq 1 1 1)
...
#For production version
export MAIN_S='/home/svdhoog/EURACE/SVN/geole/branches/Test_GA/main_sp'
export MAIN_S='/home/svdhoog/EURACE/SVN/geole/branches/Test_GA/main_reset'
export MAIN_S='/home/svdhoog/EURACE/SVN/geole/branches/Test_GA/main_no_GA'
...
#For production version
#export MAIN_S='/media/DataStorageLinux/SVN/geole/branches/Test_GA/main_sp'
#export MAIN_S='/media/DataStorageLinux/SVN/geole/branches/Test_GA/main_reset'
#export MAIN_S='/media/DataStorageLinux/SVN/geole/branches/Test_GA/main_no_reset'
export MAIN_S='/media/DataStorageLinux/SVN/geole/branches/Test_GA/main_no_GA_single'
#export MAIN_S='/media/DataStorageLinux/SVN/geole/branches/Test_GA/main_test'
...
export MODEL_XML_DIR='/media/DataStorageLinux/SVN/geole/branches/Test_GA'
