...
#10. Mark up
#export EXPERIMENT_NAME="mark_up"
#export F1_values="0.01 0.05 0.10 0.20 0.30 0.40"

#11. Investment inertia
#export EXPERIMENT_NAME="inv_inertia"
#export F1_values="0.0 1.0 2.5 4.0 6.0"

#12. Lambda
#export EXPERIMENT_NAME="lambda"
#export F1_values="0.0 0.25 0.5 0.75 1.0"

#13. Gamma_const: foldername values are positive, but specific.xml contains value: -$f1
export EXPERIMENT_NAME="gamma_const"
export F1_values="0.0 3.0 7.5 10.0 15.0"
