...
The policy experiment below can be run with the 0_default.xml file, except these settings should be set:
...
Range: values in the interval
[x0:dx:x1]=[-0.05:0.01:0.05]

<subsidy_trigger_off>0.03</subsidy_trigger_off>
Range: values in the interval
[x0:dx:x1]=[0.0:0.01:0.05]
