...
\includegraphics[width=8cm]{./energy_shock/png/duration_40/intensity_0.05/frequency_0/IGFirm-energy_costs_per_day.png}
...
\end{minipage}
%\caption{Energy shock parameters: duration $d=40$, intensity $\pi=0.05, periodicity $\Pi=0$.}
