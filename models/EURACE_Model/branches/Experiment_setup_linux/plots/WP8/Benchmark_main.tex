...
\item The unemployment rate approaches a stable level of $XX\%$.
\item Inflation rates are between $XX\%$ and $XX\%$ for most periods,
although in some periods inflation rates of $-20\%$ and $+20\%$ can occur.
\item The investment/GDP ratio fluctuates around $XX\%$.
\end{itemize}
...
\begin{itemize}
\item The GDP growth rate is about $3$ to $4\%$ annually, with a minimum of $XX\%$ and a maximum of $XX\%$.
\item The output growth rate is approx. $4\%$, with minima of $XX\%$ and maxima of $XX\%$.
\item The growth rate of the average wage is around $3.2\%$ per year, with minima of $2.5\%$ and maxima of $4.5\%$.
\item The growth rate of unemployment is centered around $0\%$, and fluctuates between $-16\%$ and $+20\%$ on an annual basis.
\end{itemize}
