...
for folder1 in $F1; do
    for folder2 in $F2; do
	echo '      Entering folder:' $folder1/$folder2
        for folder3 in $F3; do
		echo '      Entering folder:' $folder1/$folder2/$folder3
            for run in $RUNS; do
		echo '          Entering folder:' $folder1/$folder2/$folder3/'its_'$run
		cp ../$folder1/$folder2/$folder3/'its_'$run/*.png ./$folder1/$folder2/$folder3
            done
        done
    done
done
