...
/** \def ALPHA
 * \brief Provide access to environment variables in uppercase. */
#define ALPHA (FLAME_get_environment_variable_alpha())
/** \def BETA
 * \brief Provide access to environment variables in uppercase. */
#define BETA (FLAME_get_environment_variable_beta())
/** \def DEPRECIATION_RATE
 * \brief Provide access to environment variables in uppercase. */
#define DEPRECIATION_RATE (FLAME_get_environment_variable_depreciation_rate())
/** \def DISCOUNT_RATE
 * \brief Provide access to environment variables in uppercase. */
#define DISCOUNT_RATE (FLAME_get_environment_variable_discount_rate())
/** \def TETA
 * \brief Provide access to environment variables in uppercase. */
#define TETA (FLAME_get_environment_variable_teta())
/** \def MARK_UP
 * \brief Provide access to environment variables in uppercase. */
 ...
 * \brief Provide access to environment variables in uppercase. */
#define INVENTORY_COSTS_PER_UNIT (FLAME_get_environment_variable_inventory_costs_per_unit())
/** \def ON_THE_JOB_SEARCH_RATE
 * \brief Provide access to environment variables in uppercase. */
#define ON_THE_JOB_SEARCH_RATE (FLAME_get_environment_variable_on_the_job_search_rate())
/** \def INITIAL_CONSUMPTION_PROPENSITY
 * \brief Provide access to environment variables in uppercase. */
#define INITIAL_CONSUMPTION_PROPENSITY (FLAME_get_environment_variable_initial_consumption_propensity())
/** \def CONSUMPTION_PROPENSITY
 * \brief Provide access to environment variables in uppercase. */
#define CONSUMPTION_PROPENSITY (FLAME_get_environment_variable_consumption_propensity())
 ...
 * \brief Provide access to environment variables in uppercase. */
#define INNOVATION_PROBABILITY (FLAME_get_environment_variable_innovation_probability())
/** \def PRODUCTIVITY_PROGRESS
 * \brief Provide access to environment variables in uppercase. */
#define PRODUCTIVITY_PROGRESS (FLAME_get_environment_variable_productivity_progress())
...
/** \def SWITCH_STOCK_CONSISTENCY_CHECK
 * \brief Provide access to environment variables in uppercase. */
#define SWITCH_STOCK_CONSISTENCY_CHECK (FLAME_get_environment_variable_switch_stock_consistency_check())
/** \def SWITCH_FLOW_CONSISTENCY_CHECK
 * \brief Provide access to environment variables in uppercase. */
#define SWITCH_FLOW_CONSISTENCY_CHECK (FLAME_get_environment_variable_switch_flow_consistency_check())
...
/** \def DISCRETE_SHOCK
 * \brief Provide access to environment variables in uppercase. */
#define DISCRETE_SHOCK (FLAME_get_environment_variable_discrete_shock())
...
/** \def CONST_ENERGY_PRICE_MARKUP
 * \brief Provide access to environment variables in uppercase. */
#define CONST_ENERGY_PRICE_MARKUP (FLAME_get_environment_variable_const_energy_price_markup())
...
#define START_BANK_IDENTITY_MESSAGE_LOOP  bank_identity_message = get_first_bank_identity_message(); while(bank_identity_message) {
/** \def FINISH_BANK_IDENTITY_MESSAGE_LOOP
 * \brief Finish of loop to process bank_identity messages. */
#define FINISH_BANK_IDENTITY_MESSAGE_LOOP bank_identity_message = get_next_bank_identity_message(bank_identity_message); }
...
#define START_BANK_INTEREST_PAYMENT_MESSAGE_LOOP  bank_interest_payment_message = get_first_bank_interest_payment_message(); while(bank_interest_payment_message) {
/** \def FINISH_BANK_INTEREST_PAYMENT_MESSAGE_LOOP
 * \brief Finish of loop to process bank_interest_payment messages. */
#define FINISH_BANK_INTEREST_PAYMENT_MESSAGE_LOOP bank_interest_payment_message = get_next_bank_interest_payment_message(bank_interest_payment_message); }
...
/** \def START_GOV_BOND_MESSAGE_LOOP
 * \brief Start of loop to process gov_bond messages. */
#define START_GOV_BOND_MESSAGE_LOOP  gov_bond_message = get_first_gov_bond_message(); while(gov_bond_message) {
/** \def FINISH_GOV_BOND_MESSAGE_LOOP
 * \brief Finish of loop to process gov_bond messages. */
#define FINISH_GOV_BOND_MESSAGE_LOOP gov_bond_message = get_next_gov_bond_message(gov_bond_message); }
...
/** \def START_FIRM_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Start of loop to process firm_balance_sheet messages. */
#define START_FIRM_BALANCE_SHEET_MESSAGE_LOOP  firm_balance_sheet_message = get_first_firm_balance_sheet_message(); while(firm_balance_sheet_message) {
/** \def FINISH_FIRM_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Finish of loop to process firm_balance_sheet messages. */
#define FINISH_FIRM_BALANCE_SHEET_MESSAGE_LOOP firm_balance_sheet_message = get_next_firm_balance_sheet_message(firm_balance_sheet_message); }
/** \def START_HOUSEHOLD_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Start of loop to process household_balance_sheet messages. */
#define START_HOUSEHOLD_BALANCE_SHEET_MESSAGE_LOOP  household_balance_sheet_message = get_first_household_balance_sheet_message(); while(household_balance_sheet_message) {
/** \def FINISH_HOUSEHOLD_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Finish of loop to process household_balance_sheet messages. */
#define FINISH_HOUSEHOLD_BALANCE_SHEET_MESSAGE_LOOP household_balance_sheet_message = get_next_household_balance_sheet_message(household_balance_sheet_message); }
/** \def START_IGFIRM_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Start of loop to process igfirm_balance_sheet messages. */
#define START_IGFIRM_BALANCE_SHEET_MESSAGE_LOOP  igfirm_balance_sheet_message = get_first_igfirm_balance_sheet_message(); while(igfirm_balance_sheet_message) {
/** \def FINISH_IGFIRM_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Finish of loop to process igfirm_balance_sheet messages. */
#define FINISH_IGFIRM_BALANCE_SHEET_MESSAGE_LOOP igfirm_balance_sheet_message = get_next_igfirm_balance_sheet_message(igfirm_balance_sheet_message); }
/** \def START_BANK_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Start of loop to process bank_balance_sheet messages. */
#define START_BANK_BALANCE_SHEET_MESSAGE_LOOP  bank_balance_sheet_message = get_first_bank_balance_sheet_message(); while(bank_balance_sheet_message) {
/** \def FINISH_BANK_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Finish of loop to process bank_balance_sheet messages. */
#define FINISH_BANK_BALANCE_SHEET_MESSAGE_LOOP bank_balance_sheet_message = get_next_bank_balance_sheet_message(bank_balance_sheet_message); }
/** \def START_GOV_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Start of loop to process gov_balance_sheet messages. */
#define START_GOV_BALANCE_SHEET_MESSAGE_LOOP  gov_balance_sheet_message = get_first_gov_balance_sheet_message(); while(gov_balance_sheet_message) {
/** \def FINISH_GOV_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Finish of loop to process gov_balance_sheet messages. */
#define FINISH_GOV_BALANCE_SHEET_MESSAGE_LOOP gov_balance_sheet_message = get_next_gov_balance_sheet_message(gov_balance_sheet_message); }
/** \def START_ECB_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Start of loop to process ecb_balance_sheet messages. */
#define START_ECB_BALANCE_SHEET_MESSAGE_LOOP  ecb_balance_sheet_message = get_first_ecb_balance_sheet_message(); while(ecb_balance_sheet_message) {
/** \def FINISH_ECB_BALANCE_SHEET_MESSAGE_LOOP
 * \brief Finish of loop to process ecb_balance_sheet messages. */
#define FINISH_ECB_BALANCE_SHEET_MESSAGE_LOOP ecb_balance_sheet_message = get_next_ecb_balance_sheet_message(ecb_balance_sheet_message); }


struct FLAME_output
{
	int type; /* 0=snapshot 1=Firm 2=Household 3=Mall 4=IGFirm 5=Eurostat 6=Bank 7=Government 8=Central_Bank 9=Clearinghouse */
	int format; /* 0=XML */
	char * location;
	int period;
	int phase;
...
struct potential_lender
{
	int bank_name;	/**< Datatype memory variable bank_name of type int. */
	int contacted;	/**< Datatype memory variable contacted of type int. */
};

/** \struct potential_lender_array
 * \brief Dynamic array to hold potential_lenders
 */
struct potential_lender_array
{
	int size;
	...
	struct potential_lender * array;
};

/** \var typedef potential_lender potential_lender
 * \brief Typedef for potential_lender struct.
 */
typedef struct potential_lender potential_lender;
/** \var typedef potential_lender_array potential_lender_array
 * \brief Typedef for potential_lender_array struct.
 */
typedef struct potential_lender_array potential_lender_array;
/** \struct account_item
 * \brief .
 *
 * .
...
/** \struct firm_flows_adt_array
 * \brief Dynamic array to hold firm_flows_adts
 */
struct firm_flows_adt_array
{
	int size;
	...
	struct firm_flows_adt * array;
};

/** \var typedef firm_flows_adt firm_flows_adt
 * \brief Typedef for firm_flows_adt struct.
 */
typedef struct firm_flows_adt firm_flows_adt;
/** \var typedef firm_flows_adt_array firm_flows_adt_array
 * \brief Typedef for firm_flows_adt_array struct.
 */
typedef struct firm_flows_adt_array firm_flows_adt_array;
...
struct household_stocks_adt
{
	...
	int nr_firm_shares;	/**< Datatype memory variable nr_firm_shares of type int. */
	double total_assets;	/**< Datatype memory variable total_assets of type double. */
	double total_liabilities;	/**< Datatype memory variable total_liabilities of type double. */
};
...
struct household_flows_adt
{
	...
	double stock_sales;	/**< Datatype memory variable stock_sales of type double. */
	double cum_total_dividends;	/**< Datatype memory variable cum_total_dividends of type double. */
	double monthly_consumption_expenditure;	/**< Datatype memory variable monthly_consumption_expenditure of type double. */
	double tax_payment;	/**< Datatype memory variable tax_payment of type double. */
	double stock_purchases;	/**< Datatype memory variable stock_purchases of type double. */
	double total_income;	/**< Datatype memory variable total_income of type double. */
	double total_expenses;	/**< Datatype memory variable total_expenses of type double. */
};

/** \struct household_flows_adt_array
 * \brief Dynamic array to hold household_flows_adts
 */
struct household_flows_adt_array
{
	int size;
	...
	struct household_flows_adt * array;
};

/** \var typedef household_flows_adt household_flows_adt
 * \brief Typedef for household_flows_adt struct.
 */
typedef struct household_flows_adt household_flows_adt;
/** \var typedef household_flows_adt_array household_flows_adt_array
 * \brief Typedef for household_flows_adt_array struct.
 */
typedef struct household_flows_adt_array household_flows_adt_array;
...
/** \struct igfirm_flows_adt_array
 * \brief Dynamic array to hold igfirm_flows_adts
 */
struct igfirm_flows_adt_array
{
	int size;
	...
	struct igfirm_flows_adt * array;
};

/** \var typedef igfirm_flows_adt igfirm_flows_adt
 * \brief Typedef for igfirm_flows_adt struct.
 */
typedef struct igfirm_flows_adt igfirm_flows_adt;
/** \var typedef igfirm_flows_adt_array igfirm_flows_adt_array
 * \brief Typedef for igfirm_flows_adt_array struct.
 */
typedef struct igfirm_flows_adt_array igfirm_flows_adt_array;
...
/** \struct bank_flows_adt_array
 * \brief Dynamic array to hold bank_flows_adts
 */
struct bank_flows_adt_array
{
	int size;
	...
	struct bank_flows_adt * array;
};

/** \var typedef bank_flows_adt bank_flows_adt
 * \brief Typedef for bank_flows_adt struct.
 */
typedef struct bank_flows_adt bank_flows_adt;
/** \var typedef bank_flows_adt_array bank_flows_adt_array
 * \brief Typedef for bank_flows_adt_array struct.
 */
typedef struct bank_flows_adt_array bank_flows_adt_array;
...
struct gov_flows_adt
{
	double monthly_tax_revenues;	/**< Datatype memory variable monthly_tax_revenues of type double. */
	double total_bond_financing;	/**< Datatype memory variable total_bond_financing of type double. */
	double monthly_investment_expenditure;	/**< Datatype memory variable monthly_investment_expenditure of type double. */
	double monthly_consumption_expenditure;	/**< Datatype memory variable monthly_consumption_expenditure of type double. */
	double monthly_benefit_payment;	/**< Datatype memory variable monthly_benefit_payment of type double. */
	double monthly_subsidy_payment;	/**< Datatype memory variable monthly_subsidy_payment of type double. */
	double monthly_transfer_payment;	/**< Datatype memory variable monthly_transfer_payment of type double. */
	double monthly_bond_interest_payment;	/**< Datatype memory variable monthly_bond_interest_payment of type double. */
	double total_income;	/**< Datatype memory variable total_income of type double. */
	double total_expenses;	/**< Datatype memory variable total_expenses of type double. */
};

/** \struct gov_flows_adt_array
 * \brief Dynamic array to hold gov_flows_adts
 */
struct gov_flows_adt_array
{
	int size;
	...
	struct gov_flows_adt * array;
};

/** \var typedef gov_flows_adt gov_flows_adt
 * \brief Typedef for gov_flows_adt struct.
 */
typedef struct gov_flows_adt gov_flows_adt;
/** \var typedef gov_flows_adt_array gov_flows_adt_array
 * \brief Typedef for gov_flows_adt_array struct.
 */
typedef struct gov_flows_adt_array gov_flows_adt_array;
...
struct ecb_stocks_adt
{
	double gov_bond_holdings;	/**< Datatype memory variable gov_bond_holdings of type double. */
	int nr_gov_bonds;	/**< Datatype memory variable nr_gov_bonds of type int. */
	double total_ecb_debt;	/**< Datatype memory variable total_ecb_debt of type double. */
	double payment_account_private_sector;	/**< Datatype memory variable payment_account_private_sector of type double. */
	double payment_account_public_sector;	/**< Datatype memory variable payment_account_public_sector of type double. */
...
/** \struct ecb_flows_adt_array
 * \brief Dynamic array to hold ecb_flows_adts
 */
struct ecb_flows_adt_array
{
	int size;
	...
	struct ecb_flows_adt * array;
};

/** \var typedef ecb_flows_adt ecb_flows_adt
 * \brief Typedef for ecb_flows_adt struct.
 */
typedef struct ecb_flows_adt ecb_flows_adt;
/** \var typedef ecb_flows_adt_array ecb_flows_adt_array
 * \brief Typedef for ecb_flows_adt_array struct.
 */
typedef struct ecb_flows_adt_array ecb_flows_adt_array;
...
struct firm_balance_sheet_adt
{
	...
	firm_flows_adt flows;	/**< Datatype memory variable flows of type firm_flows_adt. */
};
...
struct household_balance_sheet_adt
{
	...
	household_flows_adt flows;	/**< Datatype memory variable flows of type household_flows_adt. */
};
...
struct igfirm_balance_sheet_adt
{
	...
	igfirm_flows_adt flows;	/**< Datatype memory variable flows of type igfirm_flows_adt. */
};
...
struct bank_balance_sheet_adt
{
	...
	bank_flows_adt flows;	/**< Datatype memory variable flows of type bank_flows_adt. */
};
...
struct gov_balance_sheet_adt
{
	...
	gov_flows_adt flows;	/**< Datatype memory variable flows of type gov_flows_adt. */
};
...
struct ecb_balance_sheet_adt
{
	...
	ecb_flows_adt flows;	/**< Datatype memory variable flows of type ecb_flows_adt. */
};
...
struct xmachine_memory_Firm
{
	...
	potential_lender_array set_of_lenders;	/**< X-machine memory variable set_of_lenders of type potential_lender_array. */
...
struct xmachine_memory_Household
{
	...
	double stock_sales;	/**< X-machine memory variable stock_sales of type double. */
	double stock_purchases;	/**< X-machine memory variable stock_purchases of type double. */
	double gov_bond_purchases;	/**< X-machine memory variable gov_bond_purchases of type double. */
	double monthly_consumption_expenditure;	/**< X-machine memory variable monthly_consumption_expenditure of type double. */
	double gov_bond_holdings;	/**< X-machine memory variable gov_bond_holdings of type double. */
	int nr_gov_bonds;	/**< X-machine memory variable nr_gov_bonds of type int. */
	int nr_firm_shares;	/**< X-machine memory variable nr_firm_shares of type int. */
};
...
struct xmachine_memory_Eurostat
{
	...
	firm_balance_sheet_adt firm_balance_sheets;	/**< X-machine memory variable firm_balance_sheets of type firm_balance_sheet_adt. */
	household_balance_sheet_adt household_balance_sheets;	/**< X-machine memory variable household_balance_sheets of type household_balance_sheet_adt. */
	igfirm_balance_sheet_adt igfirm_balance_sheets;	/**< X-machine memory variable igfirm_balance_sheets of type igfirm_balance_sheet_adt. */
	gov_balance_sheet_adt gov_balance_sheets;	/**< X-machine memory variable gov_balance_sheets of type gov_balance_sheet_adt. */
	bank_balance_sheet_adt bank_balance_sheets;	/**< X-machine memory variable bank_balance_sheets of type bank_balance_sheet_adt. */
	ecb_balance_sheet_adt ecb_balance_sheets;	/**< X-machine memory variable ecb_balance_sheets of type ecb_balance_sheet_adt. */
...
struct xmachine_memory_Bank
{
	...
	double ecb_interest_rate;	/**< X-machine memory variable ecb_interest_rate of type double. */
...
struct xmachine_memory_Government
{
	...
	double total_assets;	/**< X-machine memory variable total_assets of type double. */
	double total_liabilities;	/**< X-machine memory variable total_liabilities of type double. */
	double value_bonds_outstanding;	/**< X-machine memory variable value_bonds_outstanding of type double. */
	int nr_bonds_outstanding;	/**< X-machine memory variable nr_bonds_outstanding of type int. */
};
...
struct xmachine_memory_Central_Bank
{
	...
	double equity;	/**< X-machine memory variable equity of type double. */
	double dividend_payment;	/**< X-machine memory variable dividend_payment of type double. */
	double total_ecb_debt;	/**< X-machine memory variable total_ecb_debt of type double. */
	double gov_bond_holdings;	/**< X-machine memory variable gov_bond_holdings of type double. */
	int nr_gov_bonds;	/**< X-machine memory variable nr_gov_bonds of type int. */
	double payment_account_private_sector;	/**< X-machine memory variable payment_account_private_sector of type double. */
	double payment_account_public_sector;	/**< X-machine memory variable payment_account_public_sector of type double. */
...
/** \var void* FLAME_m_central_bank_account_update_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_central_bank_account_update_composite_params;
...
/** \var void* FLAME_m_daily_revenue_to_bank_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_daily_revenue_to_bank_composite_params;
...
/** \var void* FLAME_m_BCE_return_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_BCE_return_composite_params;
...
/** \var void* FLAME_m_accountInterest_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_accountInterest_composite_params;
...
/** \var void* FLAME_m_dividend_per_share_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_dividend_per_share_composite_params;
...
/** \var void* FLAME_m_gov_bond_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_gov_bond_composite_params;

/** \struct m_gov_bond
 * \brief Holds message of type gov_bond_message.
 */
struct m_gov_bond
{
...
/** \var void* FLAME_m_capital_good_profit_distribution_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_capital_good_profit_distribution_composite_params;
...
/** \var void* FLAME_m_dividend_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_dividend_composite_params;
...
/** \var void* FLAME_m_mean_wage_for_government_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_mean_wage_for_government_composite_params;
...
/** \var void* FLAME_m_firm_balance_sheet_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_balance_sheet_composite_params;

/** \struct m_firm_balance_sheet
 * \brief Holds message of type firm_balance_sheet_message.
 */
struct m_firm_balance_sheet
{
	double payment_account;	/**< Message memory variable payment_account of type double. */
	double total_value_local_inventory;	/**< Message memory variable total_value_local_inventory of type double. */
	double total_value_capital_stock;	/**< Message memory variable total_value_capital_stock of type double. */
	double total_debt;	/**< Message memory variable total_debt of type double. */
	int current_shares_outstanding;	/**< Message memory variable current_shares_outstanding of type int. */
	double cum_revenue;	/**< Message memory variable cum_revenue of type double. */
	double labour_costs;	/**< Message memory variable labour_costs of type double. */
	double capital_costs;	/**< Message memory variable capital_costs of type double. */
	double tax_payment;	/**< Message memory variable tax_payment of type double. */
	double total_debt_installment_payment;	/**< Message memory variable total_debt_installment_payment of type double. */
	double total_interest_payment;	/**< Message memory variable total_interest_payment of type double. */
	double total_dividend_payment;	/**< Message memory variable total_dividend_payment of type double. */
	double total_assets;	/**< Message memory variable total_assets of type double. */
	double total_liabilities;	/**< Message memory variable total_liabilities of type double. */
	double total_income;	/**< Message memory variable total_income of type double. */
	double total_expenses;	/**< Message memory variable total_expenses of type double. */
};

/** \var void* FLAME_m_household_balance_sheet_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_household_balance_sheet_composite_params;

/** \struct m_household_balance_sheet
 * \brief Holds message of type household_balance_sheet_message.
 */
struct m_household_balance_sheet
{
	double payment_account;	/**< Message memory variable payment_account of type double. */
	double gov_bond_holdings;	/**< Message memory variable gov_bond_holdings of type double. */
	int nr_gov_bonds;	/**< Message memory variable nr_gov_bonds of type int. */
	int nr_firm_shares;	/**< Message memory variable nr_firm_shares of type int. */
	double wage;	/**< Message memory variable wage of type double. */
	double gov_interest;	/**< Message memory variable gov_interest of type double. */
	double stock_sales;	/**< Message memory variable stock_sales of type double. */
	double cum_total_dividends;	/**< Message memory variable cum_total_dividends of type double. */
	double monthly_consumption_expenditure;	/**< Message memory variable monthly_consumption_expenditure of type double. */
	double tax_payment;	/**< Message memory variable tax_payment of type double. */
	double stock_purchases;	/**< Message memory variable stock_purchases of type double. */
	double total_assets;	/**< Message memory variable total_assets of type double. */
	double total_liabilities;	/**< Message memory variable total_liabilities of type double. */
	double total_income;	/**< Message memory variable total_income of type double. */
	double total_expenses;	/**< Message memory variable total_expenses of type double. */
...
/** \var void* FLAME_m_igfirm_balance_sheet_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_igfirm_balance_sheet_composite_params;

/** \struct m_igfirm_balance_sheet
 * \brief Holds message of type igfirm_balance_sheet_message.
 */
struct m_igfirm_balance_sheet
{
	double payment_account;	/**< Message memory variable payment_account of type double. */
	...
	double cum_revenue;	/**< Message memory variable cum_revenue of type double. */
	double labour_costs;	/**< Message memory variable labour_costs of type double. */
	double energy_costs;	/**< Message memory variable energy_costs of type double. */
	double tax_payment;	/**< Message memory variable tax_payment of type double. */
	double total_debt_installment_payment;	/**< Message memory variable total_debt_installment_payment of type double. */
	double total_interest_payment;	/**< Message memory variable total_interest_payment of type double. */
	double total_dividend_payment;	/**< Message memory variable total_dividend_payment of type double. */
...
/** \var void* FLAME_m_bank_balance_sheet_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_balance_sheet_composite_params;

/** \struct m_bank_balance_sheet
 * \brief Holds message of type bank_balance_sheet_message.
 */
struct m_bank_balance_sheet
{
	double cash;	/**< Message memory variable cash of type double. */
	double total_credit;	/**< Message memory variable total_credit of type double. */
	double deposits;	/**< Message memory variable deposits of type double. */
	double ecb_debt;	/**< Message memory variable ecb_debt of type double. */
	double firm_loan_installments;	/**< Message memory variable firm_loan_installments of type double. */
	double firm_interest_payments;	/**< Message memory variable firm_interest_payments of type double. */
	double firm_loan_issues;	/**< Message memory variable firm_loan_issues of type double. */
	double ecb_interest_payment;	/**< Message memory variable ecb_interest_payment of type double. */
	double dividend_payment;	/**< Message memory variable dividend_payment of type double. */
	double tax_payment;	/**< Message memory variable tax_payment of type double. */
	double total_assets;	/**< Message memory variable total_assets of type double. */
	double total_liabilities;	/**< Message memory variable total_liabilities of type double. */
	double total_income;	/**< Message memory variable total_income of type double. */
...
/** \var void* FLAME_m_gov_balance_sheet_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_gov_balance_sheet_composite_params;

/** \struct m_gov_balance_sheet
 * \brief Holds message of type gov_balance_sheet_message.
 */
struct m_gov_balance_sheet
{
	double payment_account;	/**< Message memory variable payment_account of type double. */
	double value_bonds_outstanding;	/**< Message memory variable value_bonds_outstanding of type double. */
	int nr_bonds_outstanding;	/**< Message memory variable nr_bonds_outstanding of type int. */
	double monthly_tax_revenues;	/**< Message memory variable monthly_tax_revenues of type double. */
	double total_bond_financing;	/**< Message memory variable total_bond_financing of type double. */
	double monthly_investment_expenditure;	/**< Message memory variable monthly_investment_expenditure of type double. */
	double monthly_consumption_expenditure;	/**< Message memory variable monthly_consumption_expenditure of type double. */
	double monthly_benefit_payment;	/**< Message memory variable monthly_benefit_payment of type double. */
	double monthly_subsidy_payment;	/**< Message memory variable monthly_subsidy_payment of type double. */
	double monthly_transfer_payment;	/**< Message memory variable monthly_transfer_payment of type double. */
	double monthly_bond_interest_payment;	/**< Message memory variable monthly_bond_interest_payment of type double. */
	double total_assets;	/**< Message memory variable total_assets of type double. */
	double total_liabilities;	/**< Message memory variable total_liabilities of type double. */
	double total_income;	/**< Message memory variable total_income of type double. */
	double total_expenses;	/**< Message memory variable total_expenses of type double. */
...
/** \var void* FLAME_m_ecb_balance_sheet_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_ecb_balance_sheet_composite_params;

/** \struct m_ecb_balance_sheet
 * \brief Holds message of type ecb_balance_sheet_message.
 */
struct m_ecb_balance_sheet
{
	double gov_bond_holdings;	/**< Message memory variable gov_bond_holdings of type double. */
	int nr_gov_bonds;	/**< Message memory variable nr_gov_bonds of type int. */
	double total_ecb_debt;	/**< Message memory variable total_ecb_debt of type double. */
	double payment_account_private_sector;	/**< Message memory variable payment_account_private_sector of type double. */
	double payment_account_public_sector;	/**< Message memory variable payment_account_public_sector of type double. */
	double fiat_money;	/**< Message memory variable fiat_money of type double. */
	double bank_interest;	/**< Message memory variable bank_interest of type double. */
	double gov_interest;	/**< Message memory variable gov_interest of type double. */
	double gov_bond_purchase;	/**< Message memory variable gov_bond_purchase of type double. */
	double dividend_payment;	/**< Message memory variable dividend_payment of type double. */
	double total_assets;	/**< Message memory variable total_assets of type double. */
	double total_liabilities;	/**< Message memory variable total_liabilities of type double. */
	double total_income;	/**< Message memory variable total_income of type double. */
...
/** \typedef m_gov_bond m_gov_bond
 * \brief Typedef for m_gov_bond struct.
 */
typedef struct m_gov_bond m_gov_bond;
...
/** \typedef m_firm_balance_sheet m_firm_balance_sheet
 * \brief Typedef for m_firm_balance_sheet struct.
 */
typedef struct m_firm_balance_sheet m_firm_balance_sheet;

/** \typedef m_household_balance_sheet m_household_balance_sheet
 * \brief Typedef for m_household_balance_sheet struct.
 */
typedef struct m_household_balance_sheet m_household_balance_sheet;

/** \typedef m_igfirm_balance_sheet m_igfirm_balance_sheet
 * \brief Typedef for m_igfirm_balance_sheet struct.
 */
typedef struct m_igfirm_balance_sheet m_igfirm_balance_sheet;

/** \typedef m_bank_balance_sheet m_bank_balance_sheet
 * \brief Typedef for m_bank_balance_sheet struct.
 */
typedef struct m_bank_balance_sheet m_bank_balance_sheet;

/** \typedef m_gov_balance_sheet m_gov_balance_sheet
 * \brief Typedef for m_gov_balance_sheet struct.
 */
typedef struct m_gov_balance_sheet m_gov_balance_sheet;

/** \typedef m_ecb_balance_sheet m_ecb_balance_sheet
 * \brief Typedef for m_ecb_balance_sheet struct.
 */
typedef struct m_ecb_balance_sheet m_ecb_balance_sheet;
...
int Household_back_shifting_consumption_day(void);
...
int Eurostat_check_flow_consistency(void);
...
int Eurostat_check_stock_consistency(void);
...
int Bank_send_data_to_Eurostat(void);
...
int Central_Bank_send_data_to_Eurostat(void);
...
int Central_Bank_read_bond_update(void);
int ClearingHouse_receive_info_dummy(void);
int ClearingHouse_receive_orders_and_run_dummy(void);
int ClearingHouse_send_asset_information_dummy(void);
...
struct node_information
{
	...
	struct m_gov_bond * gov_bond_messages;	/**< Pointer to gov_bond message list. */
	...
	struct m_firm_balance_sheet * firm_balance_sheet_messages;	/**< Pointer to firm_balance_sheet message list. */
	struct m_household_balance_sheet * household_balance_sheet_messages;	/**< Pointer to household_balance_sheet message list. */
	struct m_igfirm_balance_sheet * igfirm_balance_sheet_messages;	/**< Pointer to igfirm_balance_sheet message list. */
	struct m_bank_balance_sheet * bank_balance_sheet_messages;	/**< Pointer to bank_balance_sheet message list. */
	struct m_gov_balance_sheet * gov_balance_sheet_messages;	/**< Pointer to gov_balance_sheet message list. */
	struct m_ecb_balance_sheet * ecb_balance_sheet_messages;	/**< Pointer to ecb_balance_sheet message list. */
...
/** \var double alpha
* \brief A constant variable from the environment. */
double FLAME_environment_variable_alpha;
/** \var double beta
* \brief A constant variable from the environment. */
double FLAME_environment_variable_beta;
/** \var double depreciation_rate
* \brief A constant variable from the environment. */
double FLAME_environment_variable_depreciation_rate;
/** \var double discount_rate
* \brief A constant variable from the environment. */
double FLAME_environment_variable_discount_rate;
/** \var double teta
* \brief A constant variable from the environment. */
double FLAME_environment_variable_teta;
/** \var double mark_up
* \brief A constant variable from the environment. */
...
/** \var double inventory_costs_per_unit
* \brief A constant variable from the environment. */
double FLAME_environment_variable_inventory_costs_per_unit;
/** \var double on_the_job_search_rate
* \brief A constant variable from the environment. */
double FLAME_environment_variable_on_the_job_search_rate;
/** \var double initial_consumption_propensity
* \brief A constant variable from the environment. */
double FLAME_environment_variable_initial_consumption_propensity;
/** \var double consumption_propensity
* \brief A constant variable from the environment. */
double FLAME_environment_variable_consumption_propensity;
...
/** \var double innovation_probability
* \brief A constant variable from the environment. */
double FLAME_environment_variable_innovation_probability;
/** \var double productivity_progress
* \brief A constant variable from the environment. */
double FLAME_environment_variable_productivity_progress;
...
/** \var int switch_stock_consistency_check
* \brief A constant variable from the environment. */
int FLAME_environment_variable_switch_stock_consistency_check;
/** \var int switch_flow_consistency_check
* \brief A constant variable from the environment. */
int FLAME_environment_variable_switch_flow_consistency_check;
...
/** \var int discrete_shock
* \brief A constant variable from the environment. */
int FLAME_environment_variable_discrete_shock;
...
/** \var double const_energy_price_markup
* \brief A constant variable from the environment. */
double FLAME_environment_variable_const_energy_price_markup;
...
/** \var m_gov_bond * temp_gov_bond_message
* \brief Pointer to m_gov_bond to initialise linked list. */
m_gov_bond * temp_gov_bond_message;
...
/** \var m_firm_balance_sheet * temp_firm_balance_sheet_message
* \brief Pointer to m_firm_balance_sheet to initialise linked list. */
m_firm_balance_sheet * temp_firm_balance_sheet_message;
/** \var m_household_balance_sheet * temp_household_balance_sheet_message
* \brief Pointer to m_household_balance_sheet to initialise linked list. */
m_household_balance_sheet * temp_household_balance_sheet_message;
/** \var m_igfirm_balance_sheet * temp_igfirm_balance_sheet_message
* \brief Pointer to m_igfirm_balance_sheet to initialise linked list. */
m_igfirm_balance_sheet * temp_igfirm_balance_sheet_message;
/** \var m_bank_balance_sheet * temp_bank_balance_sheet_message
* \brief Pointer to m_bank_balance_sheet to initialise linked list. */
m_bank_balance_sheet * temp_bank_balance_sheet_message;
/** \var m_gov_balance_sheet * temp_gov_balance_sheet_message
* \brief Pointer to m_gov_balance_sheet to initialise linked list. */
m_gov_balance_sheet * temp_gov_balance_sheet_message;
/** \var m_ecb_balance_sheet * temp_ecb_balance_sheet_message
* \brief Pointer to m_ecb_balance_sheet to initialise linked list. */
m_ecb_balance_sheet * temp_ecb_balance_sheet_message;
...
/* Pointer to list of Household agents in state 09b state */
//xmachine_memory_Household * temp_xmachine_Household_09b;
xmachine_memory_Household_state * Household_09b_state;
...
/* Pointer to list of Eurostat agents in state Eurostat_check_stocks state */
//xmachine_memory_Eurostat * temp_xmachine_Eurostat_Eurostat_check_stocks;
xmachine_memory_Eurostat_state * Eurostat_Eurostat_check_stocks_state;
/* Pointer to list of Eurostat agents in state Eurostat_check_flows state */
//xmachine_memory_Eurostat * temp_xmachine_Eurostat_Eurostat_check_flows;
xmachine_memory_Eurostat_state * Eurostat_Eurostat_check_flows_state;
...
/* Pointer to list of Government agents in state 04b state */
//xmachine_memory_Government * temp_xmachine_Government_04b;
xmachine_memory_Government_state * Government_04b_state;
...
/* Pointer to list of Central_Bank agents in state 01 state */
//xmachine_memory_Central_Bank * temp_xmachine_Central_Bank_01;
xmachine_memory_Central_Bank_state * Central_Bank_01_state;
/* Pointer to list of Central_Bank agents in state 00 state */
//xmachine_memory_Central_Bank * temp_xmachine_Central_Bank_00;
xmachine_memory_Central_Bank_state * Central_Bank_00_state;
/* Pointer to current $agent_name agent */
...
MBt_Board b_gov_bond;
MBt_Iterator i_gov_bond;
...
MBt_Board b_firm_balance_sheet;
MBt_Iterator i_firm_balance_sheet;

MBt_Board b_household_balance_sheet;
MBt_Iterator i_household_balance_sheet;

MBt_Board b_igfirm_balance_sheet;
MBt_Iterator i_igfirm_balance_sheet;

MBt_Board b_bank_balance_sheet;
MBt_Iterator i_bank_balance_sheet;

MBt_Board b_gov_balance_sheet;
MBt_Iterator i_gov_balance_sheet;

MBt_Board b_ecb_balance_sheet;
MBt_Iterator i_ecb_balance_sheet;
...
/** \var m_gov_bond * gov_bond_message
* \brief Pointer to message struct for looping through gov_bond message list */
m_gov_bond * gov_bond_message;
...
/** \var m_firm_balance_sheet * firm_balance_sheet_message
* \brief Pointer to message struct for looping through firm_balance_sheet message list */
m_firm_balance_sheet * firm_balance_sheet_message;
/** \var m_household_balance_sheet * household_balance_sheet_message
* \brief Pointer to message struct for looping through household_balance_sheet message list */
m_household_balance_sheet * household_balance_sheet_message;
/** \var m_igfirm_balance_sheet * igfirm_balance_sheet_message
* \brief Pointer to message struct for looping through igfirm_balance_sheet message list */
m_igfirm_balance_sheet * igfirm_balance_sheet_message;
/** \var m_bank_balance_sheet * bank_balance_sheet_message
* \brief Pointer to message struct for looping through bank_balance_sheet message list */
m_bank_balance_sheet * bank_balance_sheet_message;
/** \var m_gov_balance_sheet * gov_balance_sheet_message
* \brief Pointer to message struct for looping through gov_balance_sheet message list */
m_gov_balance_sheet * gov_balance_sheet_message;
/** \var m_ecb_balance_sheet * ecb_balance_sheet_message
* \brief Pointer to message struct for looping through ecb_balance_sheet message list */
m_ecb_balance_sheet * ecb_balance_sheet_message;
...
void add_sales_statistics(sales_statistics_array * array, int mall_id, data_type_sales_array * sales);
...
void init_potential_lender_array(potential_lender_array * array);
void reset_potential_lender_array(potential_lender_array * array);
void free_potential_lender_array(potential_lender_array * array);
void copy_potential_lender_array(potential_lender_array * from, potential_lender_array * to);
void add_potential_lender(potential_lender_array * array, int bank_name, int contacted);
void remove_potential_lender(potential_lender_array * array, int index);
...
void add_firm_stocks_adt(firm_stocks_adt_array * array, double payment_account, double total_value_local_inventory, double total_value_capital_stock, double total_debt, int current_shares_outstanding, double total_assets, double total_liabilities);
void remove_firm_stocks_adt(firm_stocks_adt_array * array, int index);

void init_firm_flows_adt_array(firm_flows_adt_array * array);
void reset_firm_flows_adt_array(firm_flows_adt_array * array);
void free_firm_flows_adt_array(firm_flows_adt_array * array);
void copy_firm_flows_adt_array(firm_flows_adt_array * from, firm_flows_adt_array * to);
void add_firm_flows_adt(firm_flows_adt_array * array, double cum_revenue, double labour_costs, double capital_costs, double tax_payment, double total_debt_installment_payment, double total_interest_payment, double total_dividend_payment, double total_income, double total_expenses);
void remove_firm_flows_adt(firm_flows_adt_array * array, int index);
...
void add_household_stocks_adt(household_stocks_adt_array * array, double payment_account, double gov_bond_holdings, int nr_gov_bonds, int nr_firm_shares, double total_assets, double total_liabilities);
void remove_household_stocks_adt(household_stocks_adt_array * array, int index);

void init_household_flows_adt_array(household_flows_adt_array * array);
void reset_household_flows_adt_array(household_flows_adt_array * array);
void free_household_flows_adt_array(household_flows_adt_array * array);
void copy_household_flows_adt_array(household_flows_adt_array * from, household_flows_adt_array * to);
void add_household_flows_adt(household_flows_adt_array * array, double wage, double gov_interest, double stock_sales, double cum_total_dividends, double monthly_consumption_expenditure, double tax_payment, double stock_purchases, double total_income, double total_expenses);
void remove_household_flows_adt(household_flows_adt_array * array, int index);
...
void add_igfirm_stocks_adt(igfirm_stocks_adt_array * array, double payment_account, double total_debt, int current_shares_outstanding, double total_assets, double total_liabilities);
void remove_igfirm_stocks_adt(igfirm_stocks_adt_array * array, int index);

void init_igfirm_flows_adt_array(igfirm_flows_adt_array * array);
void reset_igfirm_flows_adt_array(igfirm_flows_adt_array * array);
void free_igfirm_flows_adt_array(igfirm_flows_adt_array * array);
void copy_igfirm_flows_adt_array(igfirm_flows_adt_array * from, igfirm_flows_adt_array * to);
void add_igfirm_flows_adt(igfirm_flows_adt_array * array, double cum_revenue, double labour_costs, double energy_costs, double tax_payment, double total_debt_installment_payment, double total_interest_payment, double total_dividend_payment, double total_income, double total_expenses);
void remove_igfirm_flows_adt(igfirm_flows_adt_array * array, int index);
...
void add_bank_stocks_adt(bank_stocks_adt_array * array, double cash, double total_credit, double deposits, double ecb_debt, double total_assets, double total_liabilities);
void remove_bank_stocks_adt(bank_stocks_adt_array * array, int index);

void init_bank_flows_adt_array(bank_flows_adt_array * array);
void reset_bank_flows_adt_array(bank_flows_adt_array * array);
void free_bank_flows_adt_array(bank_flows_adt_array * array);
void copy_bank_flows_adt_array(bank_flows_adt_array * from, bank_flows_adt_array * to);
void add_bank_flows_adt(bank_flows_adt_array * array, double firm_loan_installments, double firm_interest_payments, double firm_loan_issues, double ecb_interest_payment, double dividend_payment, double tax_payment, double total_income, double total_expenses);
void remove_bank_flows_adt(bank_flows_adt_array * array, int index);
...
void add_gov_stocks_adt(gov_stocks_adt_array * array, double payment_account, double value_bonds_outstanding, int nr_bonds_outstanding, double total_assets, double total_liabilities);
void remove_gov_stocks_adt(gov_stocks_adt_array * array, int index);

void init_gov_flows_adt_array(gov_flows_adt_array * array);
void reset_gov_flows_adt_array(gov_flows_adt_array * array);
void free_gov_flows_adt_array(gov_flows_adt_array * array);
void copy_gov_flows_adt_array(gov_flows_adt_array * from, gov_flows_adt_array * to);
void add_gov_flows_adt(gov_flows_adt_array * array, double monthly_tax_revenues, double total_bond_financing, double monthly_investment_expenditure, double monthly_consumption_expenditure, double monthly_benefit_payment, double monthly_subsidy_payment, double monthly_transfer_payment, double monthly_bond_interest_payment, double total_income, double total_expenses);
void remove_gov_flows_adt(gov_flows_adt_array * array, int index);
...
void add_ecb_stocks_adt(ecb_stocks_adt_array * array, double gov_bond_holdings, int nr_gov_bonds, double total_ecb_debt, double payment_account_private_sector, double payment_account_public_sector, double fiat_money, double total_assets, double total_liabilities);
void remove_ecb_stocks_adt(ecb_stocks_adt_array * array, int index);

void init_ecb_flows_adt_array(ecb_flows_adt_array * array);
void reset_ecb_flows_adt_array(ecb_flows_adt_array * array);
void free_ecb_flows_adt_array(ecb_flows_adt_array * array);
void copy_ecb_flows_adt_array(ecb_flows_adt_array * from, ecb_flows_adt_array * to);
void add_ecb_flows_adt(ecb_flows_adt_array * array, double bank_interest, double gov_interest, double gov_bond_purchase, double dividend_payment, double total_income, double total_expenses);
void remove_ecb_flows_adt(ecb_flows_adt_array * array, int index);
...
void add_firm_balance_sheet_adt(firm_balance_sheet_adt_array * array, firm_stocks_adt * stocks, firm_flows_adt * flows);
...
void add_household_balance_sheet_adt(household_balance_sheet_adt_array * array, household_stocks_adt * stocks, household_flows_adt * flows);
...
void add_igfirm_balance_sheet_adt(igfirm_balance_sheet_adt_array * array, igfirm_stocks_adt * stocks, igfirm_flows_adt * flows);
...
void add_bank_balance_sheet_adt(bank_balance_sheet_adt_array * array, bank_stocks_adt * stocks, bank_flows_adt * flows);
...
void add_gov_balance_sheet_adt(gov_balance_sheet_adt_array * array, gov_stocks_adt * stocks, gov_flows_adt * flows);
...
void add_ecb_balance_sheet_adt(ecb_balance_sheet_adt_array * array, ecb_stocks_adt * stocks, ecb_flows_adt * flows);
...
double FLAME_get_environment_variable_alpha();
double FLAME_get_environment_variable_beta();
double FLAME_get_environment_variable_depreciation_rate();
double FLAME_get_environment_variable_discount_rate();
double FLAME_get_environment_variable_teta();
...
double FLAME_get_environment_variable_inventory_costs_per_unit();
double FLAME_get_environment_variable_on_the_job_search_rate();
double FLAME_get_environment_variable_initial_consumption_propensity();
double FLAME_get_environment_variable_consumption_propensity();
...
double FLAME_get_environment_variable_innovation_probability();
double FLAME_get_environment_variable_productivity_progress();
...
int FLAME_get_environment_variable_switch_stock_consistency_check();
int FLAME_get_environment_variable_switch_flow_consistency_check();
...
int FLAME_get_environment_variable_discrete_shock();
int FLAME_get_environment_variable_energy_shock_start();
int FLAME_get_environment_variable_energy_shock_end();
double FLAME_get_environment_variable_const_energy_price_markup();
...
void init_data_type_sales(data_type_sales * temp);
void init_data_type_sales_static_array(data_type_sales * array, int size);
...
void init_temporary_sales_statistics(temporary_sales_statistics * temp);
void init_temporary_sales_statistics_static_array(temporary_sales_statistics * array, int size);
...
void init_potential_lender(potential_lender * temp);
void init_potential_lender_static_array(potential_lender * array, int size);
...
void init_firm_stocks_adt(firm_stocks_adt * temp);
void init_firm_stocks_adt_static_array(firm_stocks_adt * array, int size);
...
void init_firm_flows_adt(firm_flows_adt * temp);
void init_firm_flows_adt_static_array(firm_flows_adt * array, int size);
...
void init_household_stocks_adt(household_stocks_adt * temp);
void init_household_stocks_adt_static_array(household_stocks_adt * array, int size);
...
void init_household_flows_adt(household_flows_adt * temp);
void init_household_flows_adt_static_array(household_flows_adt * array, int size);
...
void init_igfirm_stocks_adt(igfirm_stocks_adt * temp);
void init_igfirm_stocks_adt_static_array(igfirm_stocks_adt * array, int size);
...
void init_igfirm_flows_adt(igfirm_flows_adt * temp);
void init_igfirm_flows_adt_static_array(igfirm_flows_adt * array, int size);
...
void init_bank_stocks_adt(bank_stocks_adt * temp);
void init_bank_stocks_adt_static_array(bank_stocks_adt * array, int size);
...
void init_bank_flows_adt(bank_flows_adt * temp);
void init_bank_flows_adt_static_array(bank_flows_adt * array, int size);
...
void init_gov_stocks_adt(gov_stocks_adt * temp);
void init_gov_stocks_adt_static_array(gov_stocks_adt * array, int size);
...
void init_gov_flows_adt(gov_flows_adt * temp);
void init_gov_flows_adt_static_array(gov_flows_adt * array, int size);
...
void init_ecb_stocks_adt(ecb_stocks_adt * temp);
void init_ecb_stocks_adt_static_array(ecb_stocks_adt * array, int size);
...
void init_ecb_flows_adt(ecb_flows_adt * temp);
void init_ecb_flows_adt_static_array(ecb_flows_adt * array, int size);
...
void init_firm_balance_sheet_adt(firm_balance_sheet_adt * temp);
void init_firm_balance_sheet_adt_static_array(firm_balance_sheet_adt * array, int size);
...
void init_household_balance_sheet_adt(household_balance_sheet_adt * temp);
void init_household_balance_sheet_adt_static_array(household_balance_sheet_adt * array, int size);
...
void init_igfirm_balance_sheet_adt(igfirm_balance_sheet_adt * temp);
void init_igfirm_balance_sheet_adt_static_array(igfirm_balance_sheet_adt * array, int size);
...
void init_bank_balance_sheet_adt(bank_balance_sheet_adt * temp);
void init_bank_balance_sheet_adt_static_array(bank_balance_sheet_adt * array, int size);
...
void init_gov_balance_sheet_adt(gov_balance_sheet_adt * temp);
void init_gov_balance_sheet_adt_static_array(gov_balance_sheet_adt * array, int size);
...
void init_ecb_balance_sheet_adt(ecb_balance_sheet_adt * temp);
void init_ecb_balance_sheet_adt_static_array(ecb_balance_sheet_adt * array, int size);
...
void free_potential_lender(potential_lender * temp);
void free_potential_lender_static_array(potential_lender * array, int size);
void copy_potential_lender(potential_lender * from, potential_lender * to);
void copy_potential_lender_static_array(potential_lender * from, potential_lender * to, int size);
...
void free_firm_flows_adt(firm_flows_adt * temp);
void free_firm_flows_adt_static_array(firm_flows_adt * array, int size);
void copy_firm_flows_adt(firm_flows_adt * from, firm_flows_adt * to);
void copy_firm_flows_adt_static_array(firm_flows_adt * from, firm_flows_adt * to, int size);
...
void free_household_flows_adt(household_flows_adt * temp);
void free_household_flows_adt_static_array(household_flows_adt * array, int size);
void copy_household_flows_adt(household_flows_adt * from, household_flows_adt * to);
void copy_household_flows_adt_static_array(household_flows_adt * from, household_flows_adt * to, int size);
...
void free_igfirm_flows_adt(igfirm_flows_adt * temp);
void free_igfirm_flows_adt_static_array(igfirm_flows_adt * array, int size);
void copy_igfirm_flows_adt(igfirm_flows_adt * from, igfirm_flows_adt * to);
void copy_igfirm_flows_adt_static_array(igfirm_flows_adt * from, igfirm_flows_adt * to, int size);
...
void free_bank_flows_adt(bank_flows_adt * temp);
void free_bank_flows_adt_static_array(bank_flows_adt * array, int size);
void copy_bank_flows_adt(bank_flows_adt * from, bank_flows_adt * to);
void copy_bank_flows_adt_static_array(bank_flows_adt * from, bank_flows_adt * to, int size);
...
void free_gov_flows_adt(gov_flows_adt * temp);
void free_gov_flows_adt_static_array(gov_flows_adt * array, int size);
void copy_gov_flows_adt(gov_flows_adt * from, gov_flows_adt * to);
void copy_gov_flows_adt_static_array(gov_flows_adt * from, gov_flows_adt * to, int size);
...
void free_ecb_flows_adt(ecb_flows_adt * temp);
void free_ecb_flows_adt_static_array(ecb_flows_adt * array, int size);
void copy_ecb_flows_adt(ecb_flows_adt * from, ecb_flows_adt * to);
void copy_ecb_flows_adt_static_array(ecb_flows_adt * from, ecb_flows_adt * to, int size);
...
void add_Household_agent(int id, int region_id, int_array * neighboring_region_ids, int gov_id, int day_of_month_to_act, double payment_account, int bank_id, int partition_id, double consumption_budget, double mean_income, int week_of_month, double weekly_budget, int rationed, int mall_completely_sold_out, ordered_quantity order_quantity[], received_quantities received_quantity[], int day_of_week_to_act, int day_of_month_receive_income, double current_productivity_employer, double current_mean_specific_skills_employer, double tax_payment, double cum_total_dividends, double tax_rate_hh_capital, double tax_rate_hh_labour, double price_index, double price_index_base_period, double commuting_costs_price_level_weight, double_array * last_income, double expenditures, double received_dividend, int flag_consumption_shifting, double excess_weekly_budget, Asset_array * assetsowned, double wage, double wage_reservation, int general_skill, int on_the_job_search, int number_applications, double last_labour_income, double specific_skill, int employee_firm_id, int employer_region_id, int day_of_month_receive_benefit, double unemployment_benefit_pct, double transfer_payment, double subsidy_payment, double total_income, double total_expenses, double total_assets, double total_liabilities, double gov_interest, double stock_sales, double stock_purchases, double gov_bond_purchases, double monthly_consumption_expenditure, double gov_bond_holdings, int nr_gov_bonds, int nr_firm_shares);
...
void add_Mall_agent(int id, int region_id, int gov_id, int no_regions, int partition_id, mall_stock_array * current_stock, sales_in_mall_array * firm_revenues, double total_supply, double export_volume_matrix[], double export_value_matrix[], double export_previous_value_matrix[]);
...
void add_IGFirm_agent(int id, int region_id, int gov_id, int bank_id, int day_of_month_to_act, double payment_account, int partition_id, double productivity, double capital_good_price, double revenue_per_day, double tax_rate_corporate, double tax_rate_vat, double tax_payment, double net_profit, int outstanding_shares, double current_dividend_per_share, double earnings, double energy_price_markup, double energy_costs_per_day, double earnings_per_day, double cum_energy_costs, int age, double transfer_payment, double subsidy_payment);
...
void add_Bank_agent(int id, int region_id, int gov_id, int partition_id, double cash, double total_credit, double equity, double ecb_debt, double alfa, double value_at_risk, double bank_gamma[], double profits[], double bank_lambda, double ecb_interest_rate, double bank_dividend_rate, double tax_rate_corporate, int current_shares_outstanding, double debt_period, int loan_request_message_found, int day_of_month_to_act, double deposits, double firm_loan_installments, double firm_interest_payments, double firm_loan_issues, double ecb_interest_payment, double dividend_payment, double taxes, double total_income, double total_expenses, double total_assets, double total_liabilities);
...
void add_Government_agent(int id, int_array * list_of_regions, double payment_account, int day_of_month_to_act, int partition_id, int region_id, double unemployment_benefit_pct, double money_financing_fraction, double gdp_fraction_consumption, double gdp_fraction_investment, double tax_rate_corporate, double tax_rate_hh_labour, double tax_rate_hh_capital, double tax_rate_vat, double monthly_tax_revenues, double yearly_tax_revenues, double monthly_benefit_payment, double yearly_benefit_payment, double hh_transfer_payment, double firm_transfer_payment, double monthly_transfer_payment, double yearly_transfer_payment, double hh_subsidy_payment, double firm_subsidy_payment, double monthly_subsidy_payment, double yearly_subsidy_payment, double monthly_bond_interest_payment, double yearly_bond_interest_payment, double gov_interest_rate, double yearly_investment_expenditure, double yearly_consumption_expenditure, double yearly_income, double yearly_expenditure, double total_debt, double yearly_budget_balance, double total_money_financing, double total_bond_financing, double country_wide_mean_wage, int num_unemployed, double gdp, double gdp_growth, double gdp_forecast, double yearly_income_forecast, double yearly_expenditure_budget, double budget_balance_forecast, double monthly_consumption_expenditure, double monthly_investment_expenditure, double monthly_budget_balance, double monthly_consumption_budget, double monthly_investment_budget, double monthly_income, double monthly_expenditure, double yearly_consumption_budget, double yearly_investment_budget, double total_assets, double total_liabilities, double value_bonds_outstanding, int nr_bonds_outstanding);
...
void add_Central_Bank_agent(int id, int partition_id, account_item_array * accounts, double ecb_interest_rate, double equity, double dividend_payment, double total_ecb_debt, double gov_bond_holdings, int nr_gov_bonds, double payment_account_private_sector, double payment_account_public_sector, double fiat_money, double bank_interest, double gov_interest, double gov_bond_purchase, double total_income, double total_expenses, double total_assets, double total_liabilities);
...
void add_Clearinghouse_agent(int id, int region_id, int partition_id, Asset_array * assets, ClearingMechanism clearingmechanism);
...
m_gov_bond * add_gov_bond_message_internal(void);
m_gov_bond * get_first_gov_bond_message(void);
m_gov_bond * get_next_gov_bond_message(m_gov_bond * current);
void freegov_bondmessages(void);
...
m_firm_balance_sheet * add_firm_balance_sheet_message_internal(void);
m_firm_balance_sheet * get_first_firm_balance_sheet_message(void);
m_firm_balance_sheet * get_next_firm_balance_sheet_message(m_firm_balance_sheet * current);
void freefirm_balance_sheetmessages(void);
...
m_household_balance_sheet * add_household_balance_sheet_message_internal(void);
m_household_balance_sheet * get_first_household_balance_sheet_message(void);
m_household_balance_sheet * get_next_household_balance_sheet_message(m_household_balance_sheet * current);
void freehousehold_balance_sheetmessages(void);
...
m_igfirm_balance_sheet * add_igfirm_balance_sheet_message_internal(void);
m_igfirm_balance_sheet * get_first_igfirm_balance_sheet_message(void);
m_igfirm_balance_sheet * get_next_igfirm_balance_sheet_message(m_igfirm_balance_sheet * current);
void freeigfirm_balance_sheetmessages(void);
...
m_bank_balance_sheet * add_bank_balance_sheet_message_internal(void);
m_bank_balance_sheet * get_first_bank_balance_sheet_message(void);
m_bank_balance_sheet * get_next_bank_balance_sheet_message(m_bank_balance_sheet * current);
void freebank_balance_sheetmessages(void);
...
m_gov_balance_sheet * add_gov_balance_sheet_message_internal(void);
m_gov_balance_sheet * get_first_gov_balance_sheet_message(void);
m_gov_balance_sheet * get_next_gov_balance_sheet_message(m_gov_balance_sheet * current);
void freegov_balance_sheetmessages(void);
...
m_ecb_balance_sheet * add_ecb_balance_sheet_message_internal(void);
m_ecb_balance_sheet * get_first_ecb_balance_sheet_message(void);
m_ecb_balance_sheet * get_next_ecb_balance_sheet_message(m_ecb_balance_sheet * current);
void freeecb_balance_sheetmessages(void);
...
potential_lender_array * get_set_of_lenders();
...
void set_stock_sales(double stock_sales);
double get_stock_sales();
void set_stock_purchases(double stock_purchases);
double get_stock_purchases();
void set_gov_bond_purchases(double gov_bond_purchases);
double get_gov_bond_purchases();
...
void set_gov_bond_holdings(double gov_bond_holdings);
double get_gov_bond_holdings();
void set_nr_gov_bonds(int nr_gov_bonds);
int get_nr_gov_bonds();
void set_nr_firm_shares(int nr_firm_shares);
int get_nr_firm_shares();
...
firm_balance_sheet_adt * get_firm_balance_sheets();
household_balance_sheet_adt * get_household_balance_sheets();
igfirm_balance_sheet_adt * get_igfirm_balance_sheets();
gov_balance_sheet_adt * get_gov_balance_sheets();
bank_balance_sheet_adt * get_bank_balance_sheets();
ecb_balance_sheet_adt * get_ecb_balance_sheets();
...
void set_ecb_interest_rate(double ecb_interest_rate);
double get_ecb_interest_rate();
...
void set_value_bonds_outstanding(double value_bonds_outstanding);
double get_value_bonds_outstanding();
void set_nr_bonds_outstanding(int nr_bonds_outstanding);
int get_nr_bonds_outstanding();
account_item_array * get_accounts();
void set_total_ecb_debt(double total_ecb_debt);
double get_total_ecb_debt();
void set_payment_account_private_sector(double payment_account_private_sector);
double get_payment_account_private_sector();
void set_payment_account_public_sector(double payment_account_public_sector);
double get_payment_account_public_sector();
...
m_gov_bond * get_next_message_gov_bond_in_range(m_gov_bond * current);
...
m_firm_balance_sheet * get_next_message_firm_balance_sheet_in_range(m_firm_balance_sheet * current);
m_household_balance_sheet * get_next_message_household_balance_sheet_in_range(m_household_balance_sheet * current);
m_igfirm_balance_sheet * get_next_message_igfirm_balance_sheet_in_range(m_igfirm_balance_sheet * current);
m_bank_balance_sheet * get_next_message_bank_balance_sheet_in_range(m_bank_balance_sheet * current);
m_gov_balance_sheet * get_next_message_gov_balance_sheet_in_range(m_gov_balance_sheet * current);
m_ecb_balance_sheet * get_next_message_ecb_balance_sheet_in_range(m_ecb_balance_sheet * current);
