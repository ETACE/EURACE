...
int Household_send_unemployment_benefit_notification()
{
	...
	//printf("\n UNEMPLOYMENT_BENEFIT_PCT: %f LAST_LABOUR_INCOME: 
	//%	f",UNEMPLOYMENT_BENEFIT_PCT,LAST_LABOUR_INCOME);

	TOTAL_INCOME=  UNEMPLOYMENT_PAYMENT + CUM_TOTAL_DIVIDENDS +
	MONTHLY_BOND_INTEREST_INCOME;
...
int Household_send_tax_payment()
{
   ...
   // #endif
	...
	TAX_PAYMENT = additional_tax + CUM_TOTAL_DIVIDENDS*TAX_RATE_HH_CAPITAL +
	WAGE*TAX_RATE_HH_LABOUR;
