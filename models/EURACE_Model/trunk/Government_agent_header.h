...
/** \def BOND
 * \brief Direct access to bond of Government agent memory variable. */
#define BOND (current_xmachine_Government->bond)
/** \def PENDING_ORDER
 * \brief Direct access to pending_order of Government agent memory variable. */
#define PENDING_ORDER (current_xmachine_Government->pending_order)
/** \def DEFICIT
 * \brief Direct access to deficit of Government agent memory variable. */
#define DEFICIT (current_xmachine_Government->deficit)
...
/** \def MONEY_FINANCING_FRACTION
 * \brief Direct access to money_financing_fraction of Government agent memory variable. */
#define MONEY_FINANCING_FRACTION (current_xmachine_Government->money_financing_fraction)
...
/** \def MONTHLY_UNEMPLOYMENT_BENEFIT_PAYMENT
 * \brief Direct access to monthly_unemployment_benefit_payment of Government agent memory variable. */
#define MONTHLY_UNEMPLOYMENT_BENEFIT_PAYMENT (current_xmachine_Government->monthly_unemployment_benefit_payment)
/** \def YEARLY_UNEMPLOYMENT_BENEFIT_PAYMENT
 * \brief Direct access to yearly_unemployment_benefit_payment of Government agent memory variable. */
#define YEARLY_UNEMPLOYMENT_BENEFIT_PAYMENT (current_xmachine_Government->yearly_unemployment_benefit_payment)
...
/** \def HH_SUBSIDY_PAYMENT
 * \brief Direct access to hh_subsidy_payment of Government agent memory variable. */
#define HH_SUBSIDY_PAYMENT (current_xmachine_Government->hh_subsidy_payment)
/** \def FIRM_SUBSIDY_PAYMENT
 * \brief Direct access to firm_subsidy_payment of Government agent memory variable. */
#define FIRM_SUBSIDY_PAYMENT (current_xmachine_Government->firm_subsidy_payment)
...
/** \def MONTHLY_BOND_COUPON_PAYMENT
 * \brief Direct access to monthly_bond_coupon_payment of Government agent memory variable. */
#define MONTHLY_BOND_COUPON_PAYMENT (current_xmachine_Government->monthly_bond_coupon_payment)
/** \def YEARLY_BOND_COUPON_PAYMENT
 * \brief Direct access to yearly_bond_coupon_payment of Government agent memory variable. */
#define YEARLY_BOND_COUPON_PAYMENT (current_xmachine_Government->yearly_bond_coupon_payment)
...
/** \def GDP
 * \brief Direct access to gdp of Government agent memory variable. */
#define GDP (current_xmachine_Government->gdp)
/** \def GDP_GROWTH
