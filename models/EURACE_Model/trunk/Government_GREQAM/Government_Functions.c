...
*/
	...
	YEARLY_EXPENDITURE_PLAN = GDP_GROWTH*YEARLY_EXPENDITURE;
	
	BUDGET_FORECAST = YEARLY_INCOME_FORECAST - YEARLY_EXPENDITURE_PLAN;
	
	//Set the following policies:

	//Determine new government consumption
	 YEARLY_CONSUMPTION_PLAN = GOV_POLICY_GDP_FRACTION_CONSUMPTION * GDP_FORECAST;	
	 MONTHLY_CONSUMPTION_PLAN = YEARLY_CONSUMPTION_PLAN/12;
	 
	//Determine new government investment
	 YEARLY_INVESTMENT_PLAN = GOV_POLICY_GDP_FRACTION_INVESTMENT * GDP_FORECAST;
	 MONTHLY_INVESTMENT_PLAN = YEARLY_INVESTMENT_PLAN/12;
