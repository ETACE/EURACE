...
/** \def EARNINGS_PAYOUT
 * \brief Direct access to earnings_payout of Firm agent memory variable. */
#define EARNINGS_PAYOUT (current_xmachine_Firm->earnings_payout)
...
/** \def STOCK
 * \brief Direct access to stock of Firm agent memory variable. */
#define STOCK (current_xmachine_Firm->stock)
/** \def EMPLOYEES
