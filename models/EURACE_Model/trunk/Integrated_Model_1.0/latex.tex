...
\midrule
\url{Firm_send_vacancies} & \parbox{10cm}{If additional workers are needed the firm sends vacancies messages\&\#xd;\&\#xd;\&\#xd;\&\#xd;
...
\midrule
\url{Firm_read_job_applications_send_job_offer_or_rejection} & \parbox{10cm}{Firm reads the application, ranks the applicants according to \&\#xd;\&\#xd;\&\#xd;\&\#xd;
...
\midrule
\url{Firm_read_job_responses} & \parbox{10cm}{The firm reads the responses to their job offers and updates the number of \&\#xd;\&\#xd;\&\#xd;\&\#xd;
employees and the number of vacancies} \\
\midrule
\url{Firm_read_job_quitting} & \parbox{10cm}{The firm reads quitting messages and updates the number \&\#xd;\&\#xd;\&\#xd;\&\#xd;
...
of employees and the number of vacancies} \\
\midrule
\url{Firm_start_labour_market} & \parbox{10cm}{Dummy function if a firm has to enter the Labor Market \&\#xd;\&\#xd;\&\#xd;\&\#xd;
...
\midrule
\url{Firm_send_vacancies_2} & \parbox{10cm}{If additional workers are needed the firm sends vacancies messages\&\#xd;\&\#xd;\&\#xd;\&\#xd;
 espacially the different wage offers for the different general skill groups} \\
\midrule
\url{Firm_read_job_applications_send_job_offer_or_rejection_2} & \parbox{10cm}{Firm reads the application, ranks the applicants according to \&\#xd;\&\#xd;\&\#xd;\&\#xd;
their general and specific skills and sends as many job offers to the \&\#xd;\&\#xd;\&\#xd;\&\#xd;
first ranked applicants as the firm has vacancies to fill. \&\#xd;\&\#xd;\&\#xd;\&\#xd;
The other applicants are refused.} \\
\midrule
\url{Firm_read_job_responses_2} & \parbox{10cm}{The firm reads the responses to their job offers and updates the number of \&\#xd;\&\#xd;\&\#xd;\&\#xd;
employees and the number of vacancies} \\
\midrule
\url{Firm_read_job_quitting_2} & \parbox{10cm}{The firm reads quitting messages and updates the number \&\#xd;\&\#xd;\&\#xd;\&\#xd;
of employees and the number of vacancies} \\
\midrule
\url{Firm_read_job_quitting_2} & \parbox{10cm}{The firm reads quitting messages and updates the number \&\#xd;\&\#xd;\&\#xd;\&\#xd;
of employees and the number of vacancies} \\
...
\url{idle} & \parbox{10cm}{} \\
\midrule
\url{Firm_send_id_to_malls} & \parbox{10cm}{In this function the firm sends its id to the malls. The malls can set up its data array properly if the population file was built with the cloning procedure. } \\
\midrule
\url{Firm_initialize_mall_arrays} & \parbox{10cm}{In case of cloned population: Firms receive mall ids and set up their memory variables that are related to the malls.} \\
\midrule
\url{idle} & \parbox{10cm}{} \\
\midrule
\url{idle} & \parbox{10cm}{} \\
...
\url{Household_idle} & \parbox{10cm}{Household does nothing} \\
\midrule
\url{Household_read_job_offers_send_response} & \parbox{10cm}{Household reads the job offers and ranks them \&\#xd;\&\#xd;\&\#xd;\&\#xd;
according to the wage offer} \\
\midrule
\url{Household_finish_labour_market} & \parbox{10cm}{} \\
\midrule
\url{Household_read_application_rejection_update_wage_reservation} & \parbox{10cm}{Household reads the application rejections and decreases the \&\#xd;\&\#xd;\&\#xd;\&\#xd;
reservation wage} \\
\midrule
...
\midrule
\url{Household_read_job_offers_send_response_2} & \parbox{10cm}{Household reads the job offers and ranks them \&\#xd;\&\#xd;\&\#xd;\&\#xd;
according to the wage offer} \\
\midrule
\url{Household_read_application_rejection_update_wage_reservation_2} & \parbox{10cm}{Household reads the application rejections and decreases \&\#xd;\&\#xd;\&\#xd;\&\#xd;
...
\midrule
\url{Household_read_data_from_Eurostat} & \parbox{10cm}{Read the region\_wide\_mean\_wage.} \\
\end{longtable}
\end{landscape}
