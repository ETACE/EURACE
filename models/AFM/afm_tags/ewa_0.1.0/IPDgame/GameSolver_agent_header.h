/**
 * \file  FinancialAdvisor_agent_header.h
...
/** \def POSX
 * \brief Direct access to posx of FinancialAdvisor agent memory variable. */
#define POSX current_xmachine->xmachine_FinancialAdvisor->posx
/** \def POSY
 * \brief Direct access to posy of FinancialAdvisor agent memory variable. */
#define POSY current_xmachine->xmachine_FinancialAdvisor->posy
