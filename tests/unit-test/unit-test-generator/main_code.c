...
{
char car[604][MAXCHAR];
 char path[MAXPATH];
 read_intermediate_data("header.h.tmp",car,604);
...
if(variable->dim==0)
{
if(strstr(variable->type,"_array")==NULL) 
{
...
if((strstr(variable->type,"_array")!=NULL)&&(strstr(variable->type,"_static")==NULL)) 
{
...
char car[82][MAXCHAR];
 char path[MAXPATH];
 read_intermediate_data("unittest.c.tmp",car,82);
...
{
char car[747][MAXCHAR];
 char path[MAXPATH];
 read_intermediate_data("datatype.c.tmp",car,747);
